...
Low: ${arg.lowValue}<br/>`
  ...
  return (
    <>
      ...
      <Chart id="chart" title="Candlestick Financial" dataSource={dataSource}>
        <CommonSeriesSettings
        ...
        {/* y value interval, range setting(need to fix value) */}
        <ValueAxis
          tickInterval={1}
          visualRange={{ startValue: -3000000, endValue: 5000000 }}
        >
